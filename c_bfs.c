...
int bfs(int *topo, int *num_ex, int *ex_names, int *pre_priv, int *post_priv, int *pacc, int cont_cnt, int outside_id, int docker_host_id, int max_num_ex, int *node_name, int *node_priv, int *edge_start, int *edge_end, int *edge_label, int *node_cnt, int *edge_cnt){
